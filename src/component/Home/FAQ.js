...
const FAQ = () => {
  return (
    <div className="my-10">
      ...
      <div
        tabIndex="0"
        className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box w-6/12 m-auto"
      >
      ...
      >
        <div className="collapse-title text-2xl font-medium text-accent">
          I only process 25 orders. Do I still have access to your support team?
        </div>
        <div className="collapse-content">
          <p className="text-indigo-500 text-2xl">
            Absolutely! Everyone has access to our support services. The only
            difference is that pro plan users have phone support in addition to
